<?php
    class swiperSlider extends WidgetHandler {
        function proc($args) {
        	if (!$args->identifying_way) $args->identifying_way = 'generate_random_num';
            ...
            // 제목 폰트 크기
            if(!$args->subject_font_size) $args->subject_font_size = 60;

			// 내용 폰트 크기
			if(!$args->content_font_size) $args->content_font_size = 20;
            ...
            // 컨텐츠 표시 위치
			if(!$args->content_position) $args->content_position = 5;

  		  	// Slider Height
            if (!$args->slide_height) $args->slide_height = 500;

            if (!$args->content_align) $args->content_align = 'left';
